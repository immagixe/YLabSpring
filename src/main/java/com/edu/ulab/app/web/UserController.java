...
public class UserController {
    ...
    @Operation(summary = "Create user and user books row.",
            responses = {
    ...
    @Operation(summary = "Update user and user books by id.",
            responses = {
                    @ApiResponse(description = "User book",
                            content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
                                    schema = @Schema(implementation = UserBookResponse.class)))})
    ...
    @Operation(summary = "Get user and user books by id.",
            responses = {
                    @ApiResponse(description = "User book",
                            content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
                                    schema = @Schema(implementation = UserBookResponse.class)))})
    ...
    @Operation(summary = "Delete user and user books by id.")
